...
class ModelAssets:
    ...
    def predictWithXGB(self,features):
        ...
        print(str(LabelEncode.classes_[prediction]))
    ...
    def predictOnFile(self,Filename):
        ...
        print('XGBoost: ' + str(LabelEncode.classes_[prediction]))
        prediction = TFModel.predict(TFScale.transform(f.values),verbose = 0).argmax(1)
        print('Deep Learning: ' + str(LabelEncode.classes_[prediction]))
